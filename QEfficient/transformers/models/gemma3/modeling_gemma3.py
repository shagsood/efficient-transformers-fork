...
# transformers 5.12.1 dropped the `logger` re-export from
# transformers.models.gemma3.modeling_gemma3; create a module logger locally so
# `import QEfficient` keeps working on the diffusion_gemma transformers pin.
